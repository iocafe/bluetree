...
const os_char
    ...
    ecomp_gc_msg[] = "x.msg",
    ecomp_gc_color[] = "x.color",
    ecomp_gc_alive[] = "x.alive",
    ecomp_gc_LX[] = "x.LX",
    ecomp_gc_LY[] = "x.LY",
    ecomp_gc_L[] = "x.L",
    ecomp_gc_L1[] = "x.L1",
    ...
    ecomp_gc_DR[] = "x.DR",
    ecomp_gc_DD[] = "x.DD",
    ecomp_gc_back[] = "x.back",
    ecomp_gc_start[] = "x.start",
    ecomp_gc_guide[] = "x.guide";
    ...
    eDrawParams& prm)
{
    ...
    eButton *scope, *item;
    eWindow *w;
    const os_char gui_path[] = "gui/_p/open";
    ...
    item = new eButton(scope);
    item->setpropertys(ECOMP_TEXT, "metrics");
    item->setpropertys(ECOMP_SETVALUE, "imguimetrics");
    item->setpropertys(ECOMP_TARGET, gui_path);

    item = new eButton(scope);
    item->setpropertys(ECOMP_TEXT, "style editor");
    item->setpropertys(ECOMP_SETVALUE, "imguistyle");
    item->setpropertys(ECOMP_TARGET, gui_path);
